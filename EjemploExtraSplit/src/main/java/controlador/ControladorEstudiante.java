...
public class ControladorEstudiante implements ActionListener {
    ...
    public ControladorEstudiante(EstudianteDAO modelo, JFEstudiante vista) {
        ...
        this.btnSeparar = this.vista.getBtnSeparar();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == this.btnSeparar) {
            System.out.println("A separar...");
            
            JFTexto vistaTexto = new JFTexto(); 
            ControladorSeparador ctrlSeparador = new ControladorSeparador(modelo,vistaTexto);
            vista.dispose();
